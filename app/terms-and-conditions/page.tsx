  ...
  return (
    <LegalPage title="Terms & Conditions">
      <ol className="list-decimal space-y-4 pl-6">
        ...
        <li>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://www.sastabazaronline.in/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</li>
        <li>The Platform is owned by Adhyey brothers, a company incorporated under the Companies Act, 1956 with its registered office at 3rd Floor, 33 Shaktinagar Society, Peoples Char Rasta, Katargam, Surat, Gujarat - 395004, India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our')..</li>
