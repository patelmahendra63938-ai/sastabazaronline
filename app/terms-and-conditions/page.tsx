    ...
    <LegalPage title="Terms & Conditions">
      <ol className="list-decimal space-y-4 pl-6">
        ...
        <li>
          ...
          https://www.adhyeybrothers.in/ ('Website'), including the related
          mobile site and mobile application (hereinafter referred to as
          'Platform').
        </li>

        <li>
          The Platform is owned by Adhyey brothers, a company incorporated under
          the Companies Act, 1956 with its registered office at 3rd Floor, 33
          Shaktinagar Society, Peoples Char Rasta, Katargam, Surat, Gujarat -
          395004, India (hereinafter referred to as ‘Platform Owner’, 'we', 'us',
          'our')..
        </li>
        ...
        <li>
          ...
          <ol className="mt-3 list-decimal space-y-3 pl-6">
            ...
            <li>
              ...
              your own risk and discretion for which we shall not be liable to
            ...
            <li>
              ...
              provided for your convenience for provide further information..
            </li>
            ...
            <li>
              ...
              be subject to the exclusive jurisdiction of the courts in and .
            </li>
