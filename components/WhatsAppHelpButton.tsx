...
export default function WhatsAppHelpButton() {
  ...
  return (
    <button
      ...
      className="whatsapp-help-button fixed right-3 z-40 flex h-11 w-11 items-center justify-center rounded-full bg-[#25D366] p-0 text-white shadow-lg transition hover:scale-[1.03] hover:bg-[#1ebe5d] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 md:right-6 md:h-auto md:w-auto md:min-h-12 md:gap-2 md:px-4 md:py-3 md:text-sm md:font-bold"
    >
      <svg
        viewBox="0 0 32 32"
        aria-hidden="true"
      ...
      <span className="hidden md:inline">Need Help? Chat on WhatsApp</span>
    </button>
  );
}
