    ...
    <>
      {isHomepage && (
        <Link
          ...
          className="group block min-w-0 overflow-hidden rounded-xl border border-[#ead8b8] bg-white shadow-xs transition active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d7aa5b] md:hidden"
        >
      ...
      <div className={`${isHomepage ? 'hidden md:flex' : 'flex'} group relative h-full min-w-0 flex-col justify-between overflow-hidden rounded-2xl border border-[#ead8b8] bg-white transition-all duration-300 hover:-translate-y-0.5 hover:border-[#d7aa5b] hover:shadow-xl`}>
